...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    functionName(message) {
      var $async$goto = 0,
        ...
        $async$returnValue;
      var $async$functionName = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = A.countFunc(message);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$functionName, $async$completer);
    },
    countFunc(arg) {
      var num, count;
      A.printString("countFunc arg:" + A.S(arg));
      A._asInt(arg);
      for (num = arg, count = 0; num > 0;) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              new A._AsyncCompleter(t1, type$._AsyncCompleter_dynamic).complete$1(0, A.functionName(message));
              // implicit return
  ...
  A.main__closure.prototype = {
    call$1(value) {
      $.$get$_context().callMethod$2("postMessage", [B.C_JsonCodec.encode$2$toEncodable(value, null)]);
      return null;
    },
    $signature: 6
  };
